...
import coil.load
import com.example.foodyudemy.util.Constants.Companion.BASE_IMAGE_URL
import com.example.foodyudemy.R
import com.example.foodyudemy.databinding.IngredientsRowLayoutBinding
import com.example.foodyudemy.models.ExtendedIngredient
...
class IngredientsAdapter: RecyclerView.Adapter<IngredientsAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        holder.binding.ingrdientImageView.load(BASE_IMAGE_URL + ingredientsList[position].image) {
            crossfade(600)
