package com.example.foodyudemy.ui
...
import com.example.foodyudemy.databinding.ActivityDetailsBinding
...
class DetailsActivity : AppCompatActivity() {
    ...
    private fun removeFromFavorites(item: MenuItem) {
        val favoritesEntity = FavoritesEntity(savedRecipesId, args.result)
